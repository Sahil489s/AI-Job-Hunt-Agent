...
def append_to_google_sheet(sheet_id, job_title, company_name, match_score, prep_topics, acceptance_chance):
    ...
    for name in ['service_account.json', 'credentials.json']:
        full_path = os.path.join("C:/Users/ss255/OneDrive/Desktop/projects/AI-Job-Hunt-Agent", name)
    ...
    root_dir = "C:/Users/ss255/OneDrive/Desktop/projects/AI-Job-Hunt-Agent"
...
def main():
    cv_path = "C:/Users/ss255/OneDrive/Desktop/projects/AI-Job-Hunt-Agent/my-cv.pdf"
    jobs_path = "C:/Users/ss255/OneDrive/Desktop/projects/AI-Job-Hunt-Agent/linkedin_ai_jobs.json"
    ...
    for i, job in enumerate(jobs):
        ...
        output_dir = os.path.join("C:/Users/ss255/OneDrive/Desktop/projects/AI-Job-Hunt-Agent/outputs", folder_name)
